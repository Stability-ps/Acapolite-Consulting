...
begin
  return case p_service_needed
    ...
    when 'individual_sars_debt_assistance' then 6
    ...
    when 'individual_tax_number_registration' then 3
    ...
    when 'business_sars_audits_support' then 5
    when 'accounting_bookkeeping' then 5
    when 'accounting_financial_statements' then 5
    when 'accounting_management_accounts' then 4
    when 'accounting_payroll_services' then 4
    when 'accounting_monthly_accounting_services' then 6
    when 'accounting_annual_financial_reporting' then 5
    when 'support_company_registration' then 3
    when 'support_business_compliance' then 4
    when 'support_cipc_services' then 3
    when 'support_business_advisory' then 5
    when 'support_financial_compliance' then 5
    else 4
  end;
end;
$$;
