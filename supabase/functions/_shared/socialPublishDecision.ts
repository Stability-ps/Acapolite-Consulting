// Pure retry/backoff decision logic for the social publish worker, kept
// separate from the actual Meta Graph API calls so it can be unit tested
...
// social-providers/*.ts) and the backoff/give-up arithmetic lives here,
