...
CITATIONS
Only cite material that was actually provided to you below, using its exact "Citation key" in square brackets, e.g. [Tax Library: Tax Administration Act — s104] or [Past Case: VAT Input Tax Objection — Successful]. Never invent a citation, a document, a case, a section reference or a source that was not provided to you. You may also have a file_search tool available that searches the actual content of indexed source files (legislation, guides, past-case documents, and — only in case mode — this case's own documents); when you use it, ground your answer in what it actually returns rather than assuming a file's content from its title alone.
