...
const SERVICE_CREDIT_COSTS: Record<Enums<"service_request_service_needed">, number> = {
  ...
  individual_sars_debt_assistance: 6,
  individual_tax_compliance_issues: 4,
  individual_tax_clearance_certificates: 4,
  individual_objections_and_disputes: 7,
  individual_late_return_submissions: 4,
  individual_tax_number_registration: 3,
  individual_tax_status_corrections: 4,
  business_company_income_tax: 5,
  business_vat_registration: 3,
  business_vat_returns: 4,
  business_paye_registration: 4,
  business_paye_compliance: 4,
  business_sars_debt_arrangements: 6,
  business_tax_clearance_certificates: 4,
  business_sars_audits_support: 5,
  accounting_bookkeeping: 5,
  accounting_financial_statements: 5,
  accounting_management_accounts: 4,
  accounting_payroll_services: 4,
  accounting_monthly_accounting_services: 6,
  accounting_annual_financial_reporting: 5,
  support_company_registration: 3,
  support_business_compliance: 4,
  support_cipc_services: 3,
  support_business_advisory: 5,
  support_financial_compliance: 5,
};
