    ...
    <div className="rounded-[2rem] border border-[#E7E7E7] bg-white p-5 shadow-sm">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        <div className="overflow-x-auto">
          <div className="flex min-w-[720px] items-start gap-3 lg:min-w-0 lg:gap-2">
            {REQUEST_WIZARD_STEPS.map((item, index) => {
              ...
              return (
                <div
                  key={item.step}
                  className="flex min-w-[116px] flex-1 items-start gap-3"
                >
                  <div className="flex flex-col items-center">
                    ...
                    <p className="mt-3 text-sm font-semibold text-[#102B46]">
                      {item.title}
                    </p>
        ...
        <div className="inline-flex items-center gap-2 rounded-full border border-[#DCE8E1] bg-[#F6FBF8] px-4 py-2 text-xs font-semibold text-[#1A4731]">
