      ...
      <div className="container mx-auto px-6">
        <div className="grid gap-10 md:grid-cols-[1.2fr_repeat(3,1fr)]">
          <div className="space-y-4">
            ...
            <p className="text-sm text-background/50 font-body">Connecting clients with independent, registered tax practitioners</p>
            <div className="space-y-2">
              <p className="text-sm text-background/50 font-body">Copyright 2026 Acapolite Consulting. All rights reserved.</p>
              <p className="max-w-md text-xs leading-5 text-background/40 font-body">
                Acapolite Consulting is an independent professional services platform and is not affiliated with,
                endorsed by, or acting on behalf of the South African Revenue Service (SARS).
              </p>
              <a
          ...
          <div className="space-y-3">
            ...
            <div className="grid gap-2 text-sm text-background/70 font-body">
              <Link to="/tax-guides" className="hover:text-background">SARS &amp; Tax Guides</Link>
