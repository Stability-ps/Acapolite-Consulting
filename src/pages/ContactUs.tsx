...
export default function ContactUs() {
  ...
  return (
    ...
    >
      <div className="rounded-xl bg-accent/20 p-4 border border-border/60">
        <h3 className="mb-3 text-sm font-semibold text-foreground font-body">Contact Information</h3>
