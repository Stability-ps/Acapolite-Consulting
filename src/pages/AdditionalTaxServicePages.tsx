...
export const configs: Record<string, PageConfig> = {
  compliance: {
    ...
    description: "Professional assistance with SARS tax compliance status, Good Standing TCS PINs for tenders and procurement, outstanding compliance issues and Tax Compliance Status requests.",
    metaDescription: "Get help with SARS Tax Compliance Status (TCS), Good Standing PINs for tenders and procurement, outstanding returns, debt and compliance issues affecting your South African tax status.",
    intro: "A tax compliance problem can arise from outstanding returns, debt or other SARS account issues. SARS's current Tax Compliance Status system uses a single Good Standing request for tenders, procurement and every other purpose that previously used a separate paper tax clearance certificate. Acapolite can help review the taxpayer's position, identify the items affecting compliance and prepare the appropriate next steps.",
    services: ["Tax Compliance Status review", "Good Standing (tender and procurement) TCS PIN requests", "Outstanding return identification", "Tax debt and arrangement review", "TCS request support", "SARS account and notice review", "Compliance follow-up after corrective action"],
    process: ["Review the taxpayer profile and the compliance issue shown by SARS.", "Identify outstanding returns, debt or other items requiring action.", "Complete the relevant return, debt, dispute or account process within the agreed scope.", "Confirm the compliance position using SARS's My Compliance Profile and resolve any outstanding return, debt, registration or account-detail issue affecting Good Standing.", "Recheck the compliance position and address any remaining SARS requirements."],
    faqs: [
      ...
      { question: "Do I still need a \"tax clearance certificate\" for tenders?", answer: "SARS replaced the paper Tax Clearance Certificate with the Tax Compliance Status (TCS) system in 2015. There is no longer a separate \"Tender\" request type — tender and procurement purposes now use the same Good Standing TCS request as every other Tax Compliance Status requirement. \"Tax clearance certificate\" is simply the older term for what is now handled through Good Standing." },
      { question: "How does a tender issuer or business partner verify my TCS status?", answer: "SARS issues a PIN together with the Tax Compliance Status result. Sharing that PIN and the taxpayer's tax reference number lets the requesting organisation verify the status directly with SARS. This reflects the taxpayer's compliance position at the time it is checked rather than a fixed certificate valid indefinitely, so compliance needs to be maintained for as long as the PIN may still be used." },
    ],
    sources: [
      { label: "SARS — Tax Compliance Status", href: "https://www.sars.gov.za/individuals/manage-your-tax-compliance-status/" },
      ...
      { label: "SARS — How to Verify Tax Compliance Status", href: "https://www.sars.gov.za/individuals/manage-your-tax-compliance-status/how-to-verify-tax-compliance-status/" },
    ],
