...
function AssistanceCta({ title }: { title: string }) {
  return (
...
export function SarsDebtPage() {
  ...
  return (
    ...
    >
      ...
      <AssistanceCta title="Get help choosing the right SARS debt process" />
    </PageShell>
  );
}
...
export function SarsPaymentArrangementsPage() {
  ...
  return (
    ...
    >
      ...
      <AssistanceCta title="Prepare a SARS payment-arrangement request" />
    </PageShell>
  );
}
...
export function SarsCompromisePage() {
  ...
  return (
    ...
    >
      ...
      <AssistanceCta title="Prepare a properly supported Section 200 submission" />
    </PageShell>
  );
}
...
export function SarsObjectionsPage() {
  ...
  return (
    ...
    >
      ...
      <AssistanceCta title="Get help with a SARS objection or dispute" />
    </PageShell>
  );
}
